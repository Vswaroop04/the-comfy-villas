...
import deleteResident from "@/lib/fetchers/residents/deleteResident";

const deleteResidentPopup = ({
  isOpen,
  setOpen,
  email,
}: {
  ...
  async function handleDeleteListing() {
    try {
      const resp = await deleteResident(email);
...
export default deleteResidentPopup;
